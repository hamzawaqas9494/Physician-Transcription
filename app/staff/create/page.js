      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500">
              Create a Doctor or Compounder account.
            </p>
          </div>

          <Link
            href="/login"
            className="rounded-xl border bg-white px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50"
          >
            Back to Login
          </Link>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div>
                ...
                <div className="mt-4 flex items-center gap-5">
                  <div className="h-24 w-24 overflow-hidden rounded-2xl bg-slate-950 text-white">
                    {profilePreview ? (
                      <img
                        src={profilePreview}
                        alt="Profile preview"
          ...
          <aside className="rounded-2xl bg-slate-950 p-6 text-white">
            ...
            <h3 className="mt-3 text-xl font-bold">
              AWS-backed staff profiles
            </h3>

            <p className="mt-4 text-sm leading-6 text-slate-400">
              Profile pictures are stored in AWS S3 while user information
              remains in Neon PostgreSQL.
            </p>
          </aside>
        </div>
      </div>
